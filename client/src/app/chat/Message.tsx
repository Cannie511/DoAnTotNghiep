...
export default function Message({message, createAt, me, avatar, status}:Props) {
    ...
    return (
        <div className='w-full flex'>
            ...
            <div className='p-3 mx-2 dark:bg-slate-700 dark:text-white shadow-md border border-gray-300 dark:border-gray-800 rounded-lg my-2 w-fit max-w-52 md:max-w-3xl'>
                {message}
