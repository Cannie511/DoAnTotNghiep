...
export default function Message({message, createAt, me, avatar}:Props) {
    if(!me)
    return (
        <div className='w-full flex'>
            <Avatar className='items-start mt-2' img={avatar||url_img_default} rounded status="online" statusPosition="bottom-right" />
