...
export default function ControllerBar({room_id, setVideo, setAudio, audio, video}:Props) {
    ...
    return (
        <>
            <div className='w-fit fixed top-[90vh] left-1/2 transform -translate-x-1/2 bg-gray-800 rounded-full p-3 flex justify-center items-center space-x-4'>
                <Tooltip content={"ID phòng: "+room_id}>
            ...
            <ConfirmDialog openModal={openModal} setOpenModal={setOpenModal}/>
        </>
  )
}
