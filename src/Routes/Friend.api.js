...
const {findFriendController,addFriendController,deleteFriendController,getAllFriendController, getSuggestAddFriendController} = require("../Controllers/Friend.Controller");
const router = express.Router();

    //friends
router.get("/friend/:user_id/:status",async(req,res)=> getAllFriendController(req,res))
router.get("/suggest/:user_id",async(req,res) => getSuggestAddFriendController(req,res))
