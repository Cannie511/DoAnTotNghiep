...
const { createRoomController, getRoomKeyController, findRoomController, checkRoomPasswordController, getAllRoom, deleteRoomController, updatePasswordRoomController } = require('../Controllers/Room.Controller');
...
router.put('/room/updatePassword', async(req, res)=>updatePasswordRoomController(req, res));
